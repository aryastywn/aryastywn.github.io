...
<head>
    ...
    <style>
        ...
        .button-ubah {
            ...
            padding: 5px 10px; /* Mengubah padding tombol Edit */
            border-radius: 5px; /* Mengubah border-radius tombol Edit */
        ...
        .button-hapus {
            ...
            padding: 0.4rem 3rem; /* Mengubah padding tombol Hapus */
            border-radius: 5px; /* Mengubah border-radius tombol Hapus */
            display: flex;
...
<body>
    <div class="container">
        ...
        <div class="button-container">
            <button class="button" onclick="window.location.href='index.html'">Kembali ke Dashboard</button>
