...
<body>
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Menggunakan basename untuk mendapatkan nama file gambar helm
            ...
            if (move_uploaded_file($_FILES["upload_berkas"]["tmp_name"], $target_path)) {
                $query = "UPDATE tbhelm SET nama_pemesan='$nama_pemesan', no_hp='$no_hp', alamat_pemesan='$alamat_pemesan', nama_helm='$nama_helm', ukuran_helm='$ukuran_helm', jumlah_helm='$jumlah_helm', tanggal_pemesanan='$tanggal_pemesanan', metode_pembayaran='$metode_pembayaran', upload_berkas='$file_name' WHERE id_pesanan=$id_pesanan";
        
                if (mysqli_query($koneksi, $query)) {
                    // Redirect ke halaman read.php setelah update berhasil
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <label for="upload_berkas">Upload Berkas Helm:</label>
            <input type="file" name="upload_berkas" accept="image/*">
